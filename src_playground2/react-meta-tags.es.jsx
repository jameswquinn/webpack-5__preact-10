...
var MetaContextProviderWrapper = /*#__PURE__*/function (_Component) {
 ...
 _createClass(MetaContextProviderWrapper, [{
   ...
   value: function render() {
     return createElement(MetaContext.Provider, {
       value: {
 ...
 _createClass(MetaTags, [{
   ...
   value: function componentWillUnmount() {
     if (this.temporaryElement) {
       unmountComponentAtNode(this.temporaryElement);
     }
   }
 }, {
   key: "extractChildren",
   ...
   value: function handleChildrens() {
     ...
     var headComponent = createElement("div", {
       className: "react-head-temp"
     }, children);
     render(headComponent, this.temporaryElement, function () {
...
var ReactTitle = /*#__PURE__*/function (_Component) {
 ...
 _createClass(ReactTitle, [{
   key: "render",
   value: function render() {
     return createElement(MetaTags, null, createElement("title", null, this.props.title));
   }
 }]);
